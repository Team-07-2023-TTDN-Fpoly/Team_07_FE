...
public class DetailStatisticsRequest {
    ...
    //tạo khoản chi
    public DetailStatisticsRequest(Date dt_date, String dt_name, Long dt_money, String dt_text) {
    ...
    public DetailStatisticsRequest(String dt_name, Long dt_money, String dt_text) {
        this.dt_name = dt_name;
        this.dt_money = dt_money;
        this.dt_text = dt_text;
    }
